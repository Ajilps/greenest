...
*GreenNest is a future eco-friendly mountain homestay coming soon to Kanthalloor. Join our waiting list to be the first to experience it.*
    `,
  },
...
*GreenNest is building a premium eco-friendly homestay in Kanthalloor — designed specifically for travellers who want more than a standard mountain holiday.*
    `,
  },
...
## The GreenNest Approach

At GreenNest, sustainability is not a marketing strategy. It is a founding principle. Our upcoming Kanthalloor homestay is being designed with:
...
*GreenNest is coming soon to Kanthalloor, Kerala. Join the waiting list to be part of sustainable tourism done right.*
    `,
  },
};
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!post) return { title: 'Blog | GreenNest' };
  return {
    title: post.title,
          ...
          <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-16 p-8 rounded-2xl bg-[#F7F6F2] border border-gray-100 text-center">
              <p className="font-heading text-xl font-bold text-text mb-3">
                Experience Kanthalloor with GreenNest
              </p>
