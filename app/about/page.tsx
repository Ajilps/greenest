...
export const metadata: Metadata = {
  ...
  keywords: [
    'about greenest Kanthalloor',
    'sustainable homestay Kerala',
    'eco conscious resort Kerala',
    'responsible tourism Idukki',
    'community based tourism Kerala',
    'nature homestay Kanthalloor',
    'eco architecture Kerala resort',
    'family mountain retreat Kerala',
  ],
  alternates: { canonical: 'https://greenestco.in/about' },
};
...
export default function AboutPage() {
  return (
    <>
      ...
      <main>
        {/* Hero */}
        <section className="page-hero page-hero--about pt-40 pb-24">
