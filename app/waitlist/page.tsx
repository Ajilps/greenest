...
export const metadata: Metadata = {
  ...
  keywords: [
    'Kanthalloor homestay booking',
    'Kanthalloor resort booking',
    'greenest booking',
    'new resort in Kanthalloor',
    'upcoming homestay Kerala',
    'Kanthalloor early booking offers',
    'family stay Kanthalloor',
    'mountain retreat booking Kerala',
  ],
  alternates: { canonical: 'https://greenestco.in/waitlist' },
};
...
export default function WaitlistPage() {
  return (
    <>
      ...
      <main>
        {/* Hero */}
        <section className="page-hero page-hero--waitlist pt-40 pb-24">
