...
export const metadata: Metadata = {
  title: 'Invest in GreenNest – Sustainable Mountain Tourism | Kanthalloor Kerala',
  description:
    'Invest in GreenNest, a premium eco-friendly mountain homestay coming to Kanthalloor, Kerala. Explore the opportunity in sustainable tourism, projected growth, and partnership models.',
};
...
const whyInvest = [
  ...
  },
  {
    ...
    desc: 'Kanthalloor is an emerging destination with limited quality accommodation options. GreenNest is positioned to capture the early-mover advantage in this undiscovered market.',
  },
  {
    icon: Leaf,
    title: 'Sustainable = Premium',
    desc: 'Eco-conscious travellers consistently pay a premium for authentic, sustainable stays. GreenNest\'s model targets this high-value, high-intent segment.',
  },
  {
    icon: Users,
    title: 'Family & Group Focus',
    desc: 'Families and groups have longer stays, higher spending, and stronger repeat rates. GreenNest is purpose-built for this lucrative, underserved audience.',
  },
];
  ...
  return (
    <>
      ...
      <main>
        ...
        <section className="pt-32 pb-20 bg-gradient-to-br from-[#1a2a1f] via-[#2E5E4E] to-[#4F8A63]">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-white/65 text-lg leading-relaxed max-w-2xl mx-auto">
              GreenNest represents a rare opportunity to invest in a premium, eco-focused hospitality
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-gray-600 leading-relaxed mb-5">
                  GreenNest is a carefully planned eco-friendly mountain homestay being developed in
        ...
        {/* Why Invest */}
        <section className="py-24 bg-[#F7F6F2]" aria-label="Why invest in GreenNest">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <p className="text-xs uppercase tracking-widest text-secondary font-semibold mb-3">The Opportunity</p>
              <h2 className="font-heading text-4xl font-bold text-text mb-5">Why GreenNest? Why Now?</h2>
        ...
        <section className="py-24 bg-[#F7F6F2]" aria-label="Investor inquiry form">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-white rounded-3xl p-10 shadow-sm border border-gray-100">
              <div className="text-center mb-10">
                ...
                <p className="text-gray-500 text-sm max-w-md mx-auto">
                  Fill in your details and we&rsquo;ll send you the full GreenNest investment deck along with
            ...
            <div className="mt-8 text-center">
              ...
              <a
                href="https://wa.me/919999999999?text=Hello%20GreenNest%20Team%2C%20I%20am%20interested%20in%20the%20investment%20opportunity."
                target="_blank"
